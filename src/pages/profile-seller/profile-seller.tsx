        ...
        <ContainerContent>
            <MainMobileLayout>
                <div className="mx-10">
                    ...
                    <div className="mt-10 mb-16">
                        <div className="flex justify-start items-start gap-10 mt-10 sm:flex-col sm:justify-center sm:items-center">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="text-base text-gray-500">Продает товары с {periopOfSales}</div>
                                <ButtonMain
                                    type="button"
                    ...
                    <h3 className="mt-12 text-4xl pl-4 lg:text-xl lg:pl-6">Товары продавца</h3>
                    <CardItem
                        allAds={getAdsByUserId}
                        isLoading={isLoading}
                    />
                </div>
            </MainMobileLayout>
